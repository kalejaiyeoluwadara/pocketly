  ...
  return (
    <>
      <motion.button
        ...
        className="group flex w-full items-center justify-center gap-2 rounded-xl bg-red-600 py-3.5 font-semibold text-white shadow-lg shadow-red-500/25 transition-all duration-300 hover:bg-red-700 hover:shadow-xl hover:shadow-red-500/40 dark:bg-red-500 dark:hover:bg-red-600"
      >
